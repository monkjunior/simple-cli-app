...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".simple-cli-app" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".simple-cli-app")
	}
	...
	if err := viper.ReadInConfig(); err == nil {
		...
		fmt.Println("Error while reading in config:", err)
	}
}
